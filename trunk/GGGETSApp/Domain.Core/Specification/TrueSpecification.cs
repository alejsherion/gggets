...
namespace ETS.GGGETSApp.Domain.Core.Specification
{
    /// <summary>
    /// True specification
    /// </summary>
        ...
        where TEntity:class
    {
        ...
        /// <summary>
        /// <see cref="ETS.GGGETSApp.Domain.Core.Specification.Specification{TEntity}"/>
        /// </summary>
        /// <returns><see cref="ETS.GGGETSApp.Domain.Core.Specification.Specification{TEntity}"/></returns>
