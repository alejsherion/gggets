<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Services_USA.aspx.cs" Inherits="GGGETSWeb.Services_USA" %>
        ...
        <TABLE id="header_navi" border="0" cellSpacing="0" summary="footerNavi" cellPadding="0">
          ...
          <TR>
            <TD>
              <UL>
                <LI>
                    <asp:Label ID="lblHome" runat="server" Text="SERVICES" /></LI>
