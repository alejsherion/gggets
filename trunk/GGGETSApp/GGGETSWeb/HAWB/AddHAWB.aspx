<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddHAWB.aspx.cs" Inherits="GGGETSWeb.HAWB.AddHAWB" Theme="logisitc" %>
...
<body>
    ...
    <div>
            ...
            <table class="DataView" cellspacing="1" cellpadding="3">
                <tbody>
                    ...
                    <tr class="Row">
                        ...
                        <td align="left">
                            <asp:TextBox ID="Txt_Owner" runat="server" Width="250px" CssClass="TextBox"></asp:TextBox>
                            <b style="color: #FF0000;">*</b>
                            <asp:RequiredFieldValidator ID="Rfv_Owner" runat="server" ErrorMessage="*" ForeColor="Red"
                                ControlToValidate="Txt_Owner" ValidationGroup="1"></asp:RequiredFieldValidator>
                        </td>
                    </tr>
                    <tr class="AlternatingRow">
                        <td class="FieldHeader">
                    ...
                    <tr class="Row">
                        ...
                        <td align="left">
                            ...
                            <asp:TextBox ID="Txt_ShipperRegion" runat="server" Width="150px" CssClass="TextBox"></asp:TextBox>
                    ...
                    <tr class="Row">
                        ...
                        <td align="left">
                            ...
                            <asp:RegularExpressionValidator ID="Rev_ConsigneeCountry" runat="server" ControlToValidate="Txt_ConsigneeCountry"
                                ErrorMessage="只能输入字母且只能为2位！" ValidationExpression="^[a-zA-Z]{2}$" ForeColor="Red"></asp:RegularExpressionValidator>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <asp:TextBox ID="Txt_ConsigneeRegion" runat="server" Width="150px" CssClass="TextBox"></asp:TextBox>
                ...
                <tbody>
                    <tr class="Row">
                        ...
                        <td align="left">
                            ...
                            <b style="color: #FF0000;">*</b>
                            <asp:RequiredFieldValidator ID="Rfv_Piece" runat="server" ErrorMessage="*" ForeColor="Red"
                                ControlToValidate="Txt_Piece" ValidationGroup="1"></asp:RequiredFieldValidator></br>
                            <asp:RegularExpressionValidator ID="Rev_Piece" runat="server" ControlToValidate="Txt_Piece"
                                ErrorMessage="只能输入整数！" ValidationExpression="^[1-9]*$" ForeColor="Red"></asp:RegularExpressionValidator>
                        </td>
                    </tr>
                    <tr class="AlternatingRow">
                        <td class="FieldHeader">
        ...
        <div class="FooterBtnBar">
            ...
            <asp:Button ID="But_But_Runrt" runat="server" Text="返 回" OnClick="But_But_Runrt_Click"
                CssClass="InputBtn" />
        </div>
    </div>
    </form>
