<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="AddressBookAdd.aspx.cs" Inherits="GGGETSAdmin.AddressBookManage.AddressBookAdd" Theme="logisitc" %>
        ...
        <table class="DataView">
            <tbody>
                <tr class="AlternatingRow">
                    ...
                    <td>
                        <asp:TextBox ID="Txt_LoginName" runat="server"
                            ...
                            ontextchanged="Txt_LoginName_TextChanged" TabIndex="3"></asp:TextBox>
                    </td>
                </tr>
                <tr class="Row">
                    <td class="FieldHeader" align="right">
                    ...
                    <td align="left" colspan="5">
                        <asp:TextBox ID="Txt_DeliverName" runat="server" Width="500" TabIndex="4" Style="text-transform: uppercase"></asp:TextBox>
                        <b style="color: Red">*</b>
                    </td>
                </tr>
                <tr class="Row">
                    ...
                    <td align="left" colspan="5">
                        <asp:TextBox ID="Txt_DeliverAddress" runat="server" Width="500" TabIndex="5" TextMode="MultiLine"
                ...
                <tr class="Row">
                    ...
                    <td align="left">
                        <asp:TextBox ID="Txt_DeliverCountry" runat="server" Width="80" OnTextChanged="Txt_DeliverCountry_TextChanged"
                            AutoPostBack="true" TabIndex="6" Style="text-transform: uppercase"></asp:TextBox>
                        <b style="color: Red">*</b>
                    ...
                    <td align="left">
                        <asp:TextBox ID="Txt_DeliverProvince" runat="server" Width="80" TabIndex="7" Style="text-transform: uppercase"></asp:TextBox>
                    </td>
                    <td class="FieldHeader">
                        <asp:Label ID="lbl_DeliverRegion" runat="server" Text="城市:"></asp:Label>
                    </td>
                    <td align="left">
                        <asp:TextBox ID="Txt_DeliverRegion" runat="server" Width="80" OnTextChanged="Txt_DeliverRegion_TextChanged" TabIndex="8" Style="text-transform: uppercase"></asp:TextBox>
                        <b style="color: Red">*</b>
                ...
                <tr class="Row">
                    ...
                    <td align="left">
                        <asp:TextBox ID="Txt_DeliverZipCode" runat="server" Width="80" TabIndex="9"
                            Style="text-transform: uppercase"></asp:TextBox>
                        <b style="color: Red">*</b>
                    </td>
                    <td class="FieldHeader">
                    ...
                    <td align="left">
                        <asp:TextBox ID="Txt_DeliverContactor" runat="server" Width="80" TabIndex="10" Style="text-transform: uppercase"></asp:TextBox>
                        <b style="color: Red">*</b>
                    </td>
                    <td class="FieldHeader">
                    ...
                    <td align="left">
                        <asp:TextBox ID="Txt_DeliverTel" runat="server" Width="80" TabIndex="11" Style="text-transform: uppercase"></asp:TextBox>
                        <b style="color: Red">*</b>
                    </td>
                </tr>
                <tr class="Row">
                    <td align="center" colspan="6">
                        <asp:Button ID="btn_AddDeliver" runat="server" CssClass="InputBtn" Text="添 加" OnClick="btn_AddDeliver_Click" />
                        <asp:Button ID="btn_Close" runat="server" CssClass="InputBtn" Text="取 消" />
                    </td>
                </tr>
            </tbody>
        </table>
