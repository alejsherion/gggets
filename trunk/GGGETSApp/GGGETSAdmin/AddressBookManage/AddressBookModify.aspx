        ...
        <table class="DataView">
            <tbody id="tbDeliver" runat="server">
                <tr class="AlternatingRow">
                    ...
                    <td align="left">
                        ...
                        <asp:TextBox ID="Txt_Code" runat="server" ontextchanged="Txt_Code_TextChanged" 
                            AutoPostBack="True" Width="70" TabIndex="3" Style="text-transform: uppercase" CssClass="TextBox"></asp:TextBox>
                    </td>
                    <td class="FieldHeader" align="right">
                    ...
                    <td>
                        <asp:TextBox ID="Txt_LoginName" runat="server"
                            ...
                            ontextchanged="Txt_LoginName_TextChanged" MaxLength="12" TabIndex="4" CssClass="TextBox"></asp:TextBox>
                    </td>
                </tr>
                <tr class="Row">
                    <td class="FieldHeader" align="right">
                    ...
                    <td align="left" colspan="5">
                        <asp:TextBox ID="Txt_DeliverName" runat="server" MaxLength="180" Width="500" TabIndex="5" Style="text-transform: uppercase" CssClass="TextBox"></asp:TextBox>
                        <b style="color: Red">*</b>
                    </td>
                </tr>
                <tr class="Row">
                ...
                <tr class="Row">
                    ...
                    <td align="left">
                        <asp:TextBox ID="Txt_DeliverCountry" runat="server" Width="80" OnTextChanged="Txt_DeliverCountry_TextChanged"
                            AutoPostBack="true" TabIndex="7" Style="text-transform: uppercase" CssClass="TextBox"></asp:TextBox>
                        <b style="color: Red">*</b>
                    ...
                    <td align="left">
                        <asp:TextBox ID="Txt_DeliverProvince" runat="server" Width="80" TabIndex="8" Style="text-transform: uppercase" CssClass="TextBox"></asp:TextBox>
                    </td>
                    <td class="FieldHeader">
                        <asp:Label ID="lbl_DeliverRegion" runat="server" Text="城市:"></asp:Label>
                    </td>
                    <td align="left">
                        <asp:TextBox ID="Txt_DeliverRegion" runat="server" Width="80" OnTextChanged="Txt_DeliverRegion_TextChanged" TabIndex="9" Style="text-transform: uppercase" CssClass="TextBox"></asp:TextBox>
                        <b style="color: Red">*</b>
                ...
                <tr class="Row">
                    ...
                    <td align="left">
                        <asp:TextBox ID="Txt_DeliverContactor" runat="server" MaxLength="40" Width="80" TabIndex="11" Style="text-transform: uppercase" CssClass="TextBox"></asp:TextBox>
                        <b style="color: Red">*</b>
                    </td>
                    <td class="FieldHeader">
                    ...
                    <td align="left">
                        <asp:TextBox ID="Txt_DeliverTel" runat="server" Width="80" MaxLength="20" TabIndex="12" Style="text-transform: uppercase" CssClass="TextBox"></asp:TextBox>
                        <b style="color: Red">*</b>
                    </td>
                </tr>
                <tr class="Row">
