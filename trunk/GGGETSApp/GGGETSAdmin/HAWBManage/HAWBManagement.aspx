<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HAWBManagement.aspx.cs"
    Inherits="GGGETSAdmin.HAWBManage.HAWBManagement" Theme="logisitc" %>
...
<body>
    ...
    <div style="text-align: right">
        <asp:LinkButton ID="lbtn_Navigation" runat="server" Text="主页" PostBackUrl="~/Navigation.aspx"
            ...
            <thead>
                <tr class="Row">
                    ...
                    <td colspan="5" align="left">
                        <asp:TextBox ID="Txt_BarCode" runat="server" Width="500" TabIndex="1" Style="text-transform: uppercase"
                ...
                <tr class="Row">
                    ...
                    <td align="left" style="width: 80px">
                        <asp:TextBox ID="Txt_Country" runat="server" Width="80" MaxLength="2" Style="text-transform: uppercase"
                            CssClass="TextBox"></asp:TextBox>
                    </td>
                    <td class="FieldHeader" align="right">
                    ...
                    <td align="left" style="width: 80px">
                        <asp:TextBox ID="Txt_Region" runat="server" Width="80" MaxLength="3" Style="text-transform: uppercase"
                            CssClass="TextBox"></asp:TextBox>
                    </td>
                    <td class="FieldHeader" align="right">
                ...
                <tr class="Row">
                    ...
                    <td colspan="5" align="left">
                        <asp:TextBox ID="Txt_corporationName" runat="server" Width="500" Style="text-transform: uppercase"
                            CssClass="TextBox"></asp:TextBox>
                    </td>
                </tr>
                <tr class="Row">
                    ...
                    <td align="left" style="width: 80px">
                        <asp:TextBox ID="Txt_Contactor" runat="server" Width="80" Style="text-transform: uppercase"
                            CssClass="TextBox"></asp:TextBox>
                    </td>
                    <td class="FieldHeader" align="right">
                    ...
                    <td align="left">
                        <asp:TextBox ID="Txt_GetUpTime" runat="server" Width="80" onfocusin="WdatePicker()"
                            CssClass="TextBox"></asp:TextBox>-
                        <asp:TextBox ID="Txt_StopTime" runat="server" Width="80" onfocusin="WdatePicker()"
                            CssClass="TextBox"></asp:TextBox>
                    </td>
                </tr>
                <tr class="Row">
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
                <div style="height: 350px; overflow-x: auto; overflow-y: auto;">
                    <asp:GridView ID="Gv_HAWB" runat="server" AutoGenerateColumns="False" OnRowCommand="Gv_HAWB_RowCommand"
                        DataKeyNames="BarCode" PageSize="36" CssClass="DataView"  ondatabound="Gv_HAWB_DataBound">
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="发件公司">
                                <ItemTemplate>
                                    <asp:Label ID="lbl_ShipperName" runat="server" Text='<%# Eval("ShipperName").ToString().Length>10?Eval("ShipperName").ToString().Substring(0,10)+"":Eval("ShipperName") %>'
                                        ToolTip='<%# Eval("ShipperName")%>'></asp:Label>
                                </ItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="收件公司">
                                <ItemTemplate>
                                    <asp:Label ID="lbl_ConsigneeName" runat="server" Text='<%# Eval("ConsigneeName").ToString().Length>10?Eval("ConsigneeName").ToString().Substring(0,10)+"":Eval("ConsigneeName") %>'
                                        ToolTip='<%# Eval("ConsigneeName")%>'></asp:Label>
                                </ItemTemplate>
                                <ControlStyle Width="150px" />
                                <HeaderStyle HorizontalAlign="Center" />
                                <ItemStyle HorizontalAlign="Center" />
                            ...
                            <asp:TemplateField>
                                <ItemTemplate>
                                    <asp:LinkButton ID="lbtn_Update" runat="server" CommandName="Updata" CommandArgument='<%# Eval("BarCode") %>' Text="修改"></asp:LinkButton>
                                </ItemTemplate>
                                <ItemStyle Width="50px" />
                            </asp:TemplateField>
                            <asp:TemplateField>
                                <ItemTemplate>
                                    <asp:LinkButton ID="lbtn_Delete" CommandArgument='<%# Eval("BarCode") %>' CommandName="Del"
                                        runat="server" Text="删除" OnClientClick="javascript:return confirm('确定删除该条运单吗?');"></asp:LinkButton>
                                </ItemTemplate>
                                <ItemStyle Width="50px" />
                            </asp:TemplateField>
                            <asp:TemplateField>
                                <ItemTemplate>
                                    <asp:LinkButton ID="lbtn_Derive" CommandArgument='<%# Eval("BarCode") %>' CommandName="Derive"
                                        runat="server" Text="导出运单发票"></asp:LinkButton>
                                </ItemTemplate>
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:TemplateField>
                            <asp:TemplateField>
                                <ItemTemplate>
                                    <asp:LinkButton ID="lbtn_DeriveAccept" CommandArgument='<%# Eval("CarrierHAWBBarCode") %>'
                                        CommandName="DeriveAccept" runat="server" Text="导出承运发票"></asp:LinkButton>
                                </ItemTemplate>
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:TemplateField>
                        </Columns>
