<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="UserAdd.aspx.cs" Inherits="GGGETSAdmin.PersonnelManage.UserManage.UserAdd" Theme="logisitc" %>
    ...
    <div>
        <table class="DataView">
            <tbody>
                ...
                <tr class="Row">
                    <td class="FieldHeader" align="right">
                        <asp:Label ID="lbl_Password" runat="server" Text="用户密码:"></asp:Label>
                    </td>
                    <td align="left">
                        <asp:TextBox ID="Txt_Password" runat="server" CssClass="TextBox" TabIndex="4" TextMode="Password"></asp:TextBox>
                        <b style="color: Red">*</b></td>
                </tr>
                <tr class="AlternatingRow">
                    <td class="FieldHeader" align="right">
                        <asp:Label ID="lbl_Qpassword" runat="server" Text="确认密码:"></asp:Label>
                    </td>
                    <td align="left">
                        <asp:TextBox ID="Txt_Qpassword" runat="server" CssClass="TextBox" TabIndex="5" 
                            TextMode="Password" ontextchanged="Txt_Qpassword_TextChanged"></asp:TextBox>
                        <b style="color: Red">*</b></td>
                </tr>
                <tr class="Row">
                    <td class="FieldHeader" align="right">
