...
namespace ETS.GGGETSApp.Domain.Application.Entities
{
    ...
    public partial class Item: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        [DataMember]
        public Nullable<decimal> TransPays
        {
            get { return _transPays; }
            set
            {
                if (_transPays != value)
                {
                    _transPays = value;
                    OnPropertyChanged("TransPays");
                }
            }
        }
        private Nullable<decimal> _transPays;
    
        [DataMember]
        public Nullable<int> TransCurrency
        {
        ...
        private Nullable<int> _transCurrency;
