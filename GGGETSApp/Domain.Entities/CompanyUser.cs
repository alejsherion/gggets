...
namespace ETS.GGGETSApp.Domain.Application.Entities
{
    ...
    #endif
    public partial class CompanyUser: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        private int _weightDiscountType = 0;
        ...
        private void FixupCompany(Company previousValue, bool skipKeys = false)
        {
            ...
            if (previousValue != null && previousValue.CompanyUsers.Contains(this))
            {
            ...
            if (Company != null)
            {
                if (!Company.CompanyUsers.Contains(this))
                {
                    Company.CompanyUsers.Add(this);
                }
        ...
        private void FixupAddressBooks(object sender, NotifyCollectionChangedEventArgs e)
        {
            ...
            if (e.OldItems != null)
            {
                ...
                {
                    if (ReferenceEquals(item.CompanyUser, this))
                    {
                        item.CompanyUser = null;
                    }
                    if (ChangeTracker.ChangeTrackingEnabled)
                    {
