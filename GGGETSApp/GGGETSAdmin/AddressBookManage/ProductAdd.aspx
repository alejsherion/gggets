<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true"
    CodeBehind="ProductAdd.aspx.cs" Inherits="GGGETSAdmin.ProductManage.ProductAdd"
    Theme="logisitc" %>
                ...
                <table class="DataView">
                    ...
                    <tr class="Row">
                        ...
                        <td class="FieldHeader" align="center">
                            <asp:Button ID="btn_Addparoduct" runat="server" TabIndex="12" CssClass="InputBtn" Text="保 存"
                    ...
                    <Columns>
                        <asp:TemplateField HeaderText="行号">
                            <ItemTemplate>
                                ...
                                <asp:Label ID="lbl_PID" runat="server" Visible="false" Text='<%# Eval("HSPID") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField>
                            <HeaderTemplate>
                                <input id="CheckedAll" name="CheckedAll" type="checkbox" onclick="CheckAll(this,'<%=Gv_Productiy.ClientID %>',3)" />
                            </HeaderTemplate>
                            <ItemTemplate>
