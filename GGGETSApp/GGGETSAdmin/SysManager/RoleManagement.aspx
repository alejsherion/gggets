<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RoleManagement.aspx.cs" Inherits="GGGETSAdmin.SysManager.RoleManagement" %>
...
<body>
    ...
    <div>
                ...
                <td class="FieldHeader">
                    ...
                    <td>
                        <asp:TextBox ID="txtDescription" CssClass="TextBox" runat="server" 
                            Width="150px" MaxLength="200"></asp:TextBox>
        ...
        <asp:GridView ID="dgrdRole" runat="server" AutoGenerateColumns="False" 
            DataKeyNames="RoleID" onrowcommand="dgrdRole_RowCommand" AllowPaging="true" 
            ...
            <Columns>
                ...
                <asp:TemplateField >
                    <ItemTemplate>
                    <asp:LinkButton ID="LinkButton1" CommandName="Update" runat="server" Text="修改" CommandArgument='<%# Eval("RoleID") %>'></asp:LinkButton>&nbsp;
                        <asp:LinkButton ID="lbtn_Delete" CommandName="Del" runat="server" Text="删除" CommandArgument='<%# Eval("RoleID") %>' OnClientClick="javascript:return confirm('确定删除该条记录吗?');"></asp:LinkButton>
                    </ItemTemplate>
                </asp:TemplateField>
            </Columns>
        </asp:GridView>
