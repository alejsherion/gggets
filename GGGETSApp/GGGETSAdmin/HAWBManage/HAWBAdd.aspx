                ...
                <tbody>
                    <tr class="EditRow">
                        <td colspan="6" align="left">
                            ...
                            <asp:LinkButton ID="lbtn_Shipperhistory" runat="server" Text="[历史]"></asp:LinkButton>
                        </td>
                    </tr>
                    <tr class="Row">
                        <td class="FieldHeader">
                    ...
                    <tr class="Row">
                        ...
                        <td align="left" class="style1">
                            <asp:TextBox ID="Txt_ShipperRegion" runat="server" Width="80" TabIndex="8" MaxLength="3"></asp:TextBox>
                        </td>
                        <td class="FieldHeader">
                    ...
                    <tr class="Row">
                        ...
                        <td align="left" class="style2">
                            <asp:TextBox ID="Txt_ShipperZipCode" runat="server" Width="80" TabIndex="10" MaxLength="6"></asp:TextBox>
                        </td>
                        <td class="FieldHeader">
                ...
                <tbody>
                    <tr class="EditRow">
                        <td colspan="6" align="left">
                            ...
                            <asp:LinkButton ID="lbtn_Consigneehistory" runat="server" Text="[历史]"></asp:LinkButton>
                            &nbsp;&nbsp;&nbsp;&nbsp;
                    ...
                    <tr class="Row">
                        ...
                        <td align="left" colspan="5">
                            <asp:TextBox ID="Txt_ConsigneeAddress" runat="server" Width="800" TabIndex="15" TextMode="MultiLine"></asp:TextBox><b
                                style="color: Red">*</b>
                        </td>
                    </tr>
                    <tr class="Row">
                        ...
                        <td align="left" class="style2">
                            <asp:TextBox ID="Txt_ConsigneeCountry" runat="server" Width="80" TabIndex="16" MaxLength="2"></asp:TextBox>
                        </td>
                        <td class="FieldHeader">
                            <asp:Label ID="lbl_ConsigneeRegion" runat="server" Text="省份："></asp:Label>
                        </td>
                        <td align="left" class="style1">
                            <asp:TextBox ID="Txt_ConsigneeRegion" runat="server" Width="80" TabIndex="17" MaxLength="3"></asp:TextBox>
                        </td>
                        <td class="FieldHeader">
                    ...
                    <tr class="Row">
                        ...
                        <td align="left" class="style2">
                            <asp:TextBox ID="Txt_ConsigneeZipCode" runat="server" Width="80" TabIndex="19" MaxLength="6"></asp:TextBox>
                        </td>
                        <td class="FieldHeader">
                ...
                <tbody id="Deliver" runat="server" visible="false">
                    ...
                    <tr class="Row">
                        <td align="center" colspan="6">
                            <asp:Button ID="but_cancel" runat="server" Text="取 消" CssClass="InputBtn" OnClick="but_cancel_Click" />
                        </td>
                    </tr>
                </tbody>
            </table>
