        ...
        <table class="DataView">
            <tbody>
                ...
                <tr class="Row">
                    ...
                    <td class="FieldHeader">
                        <asp:Label ID="lbl_Province" runat="server" Text="省份："></asp:Label>
                    </td>
                    <td align="left">
                        <asp:Label ID="Txt_Province" runat="server" Width="80" ></asp:Label>
                    </td>
                    <td class="FieldHeader">
        ...
        <table class="DataView">
            <tbody>
                ...
                <tr class="Row">
                    ...
                    <td class="FieldHeader">
                        <asp:Label ID="lbl_ConsigneeCity" runat="server" Text="省份："></asp:Label>
                    </td>
                    <td align="left" class="style1">
                        <asp:Label ID="Txt_ConsigneeCity" runat="server" Width="80" TabIndex="17" ></asp:Label>
                    </td>
                    <td class="FieldHeader">
                        <asp:Label ID="lbl_ConsigneeRegion" runat="server" Text="城市："></asp:Label>
                    </td>
                    <td align="left">
                        <asp:Label ID="Txt_ConsigneeRegion" runat="server" Width="80" TabIndex="18" ></asp:Label>
                    </td>
                </tr>
                <tr class="Row">
                    <td class="FieldHeader">
...
<div>
    ...
    <table>
        <tbody>
            ...
            <tr class="Row">
                <td class="FieldHeader">
                    <asp:Label ID="lbl_CarrierHAWBBarCode" runat="server" Text="承运公司运单号："></asp:Label></td>
                <td align="left" colspan="7">
                    <asp:Label ID="Txt_CarrierHAWBBarCode" runat="server" Width="422px" ></asp:Label>
               </td>
            </tr>
        </tbody>
    </table>
...
<div class="FooterBtnBar">
    ...
    <asp:Button ID="But_Conel" runat="server" Text="返 回" CssClass="InputBtn" 
     ...
     <asp:Button ID="btn_DeriveSince" runat="server" Text="导出运单发票" 
        CssClass="InputBtn" onclick="btn_DeriveSince_Click"/>&nbsp;&nbsp;&nbsp;&nbsp;
        <asp:Button ID="btn_DeriveAccept" runat="server" Text="导出承运单发票" 
