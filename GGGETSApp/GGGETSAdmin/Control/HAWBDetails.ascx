<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="HAWBDetails.ascx.cs" Inherits="GGGETSAdmin.Control.HAWBDetails" %>
<div>
...
<div>
    ...
    <table>
        <tbody>
            <tr class="Row">
                <td class="FieldHeader">
                    <asp:Label ID="Label1" runat="server" Text="计重类型："></asp:Label></td>
                <td align="left">
...
<div class="FooterBtnBar">
    <asp:Button ID="But_Next" runat="server" Text="修 改" CssClass="InputBtn" TabIndex="30" />
