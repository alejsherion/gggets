<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="HAWBGuoJi.ascx.cs" Inherits="GGGETSAdmin.Control.HAWBGuoJi" %>
            ...
            <tbody>
                <tr class="EditRow">
                    <td colspan="6" align="left">
                        ...
                        &nbsp;&nbsp;&nbsp;&nbsp;
                        <asp:LinkButton ID="lbtn_AddConsignee" runat="server" Text="添加交付人信息" 
                            CssClass="LinkBtn" onclick="lbtn_AddConsignee_Click"></asp:LinkButton>
...
<div class="FooterBtnBar">
    <asp:Button ID="But_Next" runat="server" Text="下一页" CssClass="InputBtn" 
...
<script type="text/javascript">
    ...
    function but_cancel() {
        document.getElementById("ContentPlaceHolder1_HAWBGuoJi1_Deliver").style.display = "none"; //
    }
</script>
