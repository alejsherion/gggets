            ...
            <table class="DataView" cellspacing="1" cellpadding="3">
                ...
                <tbody>
                    ...
                    <tr class="Row">
                        ...
                        <td align="left">
                            <asp:TextBox ID="Txt_ShipperCountry" runat="server" Width="50px" CssClass="TextBox" MaxLength="2"></asp:TextBox>
                            ...
                            <asp:TextBox ID="Txt_ShipperRegion" runat="server" Width="50px" CssClass="TextBox" MaxLength="3"></asp:TextBox>
                    ...
                    <tr class="Row">
                        ...
                        <td align="left">
                            <asp:TextBox ID="Txt_ConsigneeCountry" runat="server" Width="50px" CssClass="TextBox" MaxLength="2"></asp:TextBox>
                            <asp:RegularExpressionValidator ID="Rev_ConsigneeCountry" runat="server" ControlToValidate="Txt_ConsigneeCountry"
                                ErrorMessage="只能输入字母且只能为2位！" ValidationExpression="^[a-zA-Z]{2}$" ForeColor="Red"></asp:RegularExpressionValidator>
                            <asp:TextBox ID="Txt_ConsigneeRegion" runat="server" Width="50px" CssClass="TextBox" MaxLength="3"></asp:TextBox>
