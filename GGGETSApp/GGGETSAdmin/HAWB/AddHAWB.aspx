<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="AddHAWB.aspx.cs" Inherits="GGGETSAdmin.HAWB1.NewHAWB" %>
                ...
                <div>
                    <table>
                        ...
                        <tr>
                            ...
                            <td>负责人:</td>
                            <td><asp:TextBox ID="Txt_Owner" runat="server" Enabled="false"></asp:TextBox></td>
                        </tr>
                    </table>
                    <table>
                        <tr>
                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <td>添加货物信息</td>
                            <td>
                                <asp:Button ID="But_AddItme" runat="server" Text="添加货物信息" 
                                    onclick="But_AddItme_Click" /></td>
                        </tr>
                    </table>
                    <table>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>国际/国内运单:</td>
                            <td>
                                <asp:DropDownList ID="DDL_IsInternational" runat="server">
                                    <asp:ListItem Value="true">国内</asp:ListItem>
                                    <asp:ListItem Value="false">国外</asp:ListItem>
                                </asp:DropDownList>
                             </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td align="center" colspan="4">
                                <asp:Button ID="But_AddHAWB" runat="server" Text="提交" 
