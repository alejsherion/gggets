        ...
        <table class="DataView">
            <tbody>
                ...
                <tr class="AlternatingRow">
                    ...
                    <td align="left">
                        <asp:TextBox ID="Txt_FullName" runat="server" CssClass="TextBox" TabIndex="2" Width="300" Style="text-transform: uppercase"></asp:TextBox><b style="color: Red">*</b> 
                    </td>
                </tr>
                <tr class="Row">
                    <td class="FieldHeader" align="right">
                ...
                <tr class="AlternatingRow">
                    ...
                    <td align="left">
                        <asp:TextBox ID="Txt_Phone" runat="server" CssClass="TextBox" TabIndex="6"></asp:TextBox>
                    </td>
                </tr>
                <tr class="Row">
                    <td class="FieldHeader" align="right">
                    ...
                    <td align="left">
                        <asp:TextBox ID="Txt_Fax" runat="server" CssClass="TextBox" TabIndex="6"></asp:TextBox>
                    </td>
                </tr>
                <tr class="AlternatingRow">
                    <td class="FieldHeader" align="right">
                    ...
                    <td align="left">
                        <asp:TextBox ID="Txt_PostCode" runat="server" CssClass="TextBox" TabIndex="7"></asp:TextBox>
                        <b style="color: Red">*</b>
                    </td>
                </tr>
                <tr class="Row">
                    ...
                    <td align="left">
                        <asp:TextBox ID="Txt_Address" runat="server" CssClass="TextBox" TabIndex="8" Width="300" TextMode="MultiLine" Style="text-transform: uppercase"></asp:TextBox>
                        <b style="color: Red">*</b>
                    </td>
                </tr>
                <tr class="AlternatingRow">
                    ...
                    <td align="left">
                        <asp:TextBox ID="Txt_OrganizationCode" runat="server" CssClass="TextBox" TabIndex="9" Style="text-transform: uppercase"></asp:TextBox>
                    </td>
                </tr>
                <tr class="Row">
                    <td class="FieldHeader" align="right">
                    ...
                    <td align="left">
                        <asp:TextBox ID="Txt_Remark" runat="server" CssClass="TextBox" TabIndex="10" TextMode="MultiLine" Width="300" Style="text-transform: uppercase"></asp:TextBox>
                    </td>
                </tr>
            </tbody>
        </table>
