<%@ Page Title="" Language="C#" MasterPageFile="~/GETS.Master" AutoEventWireup="true" CodeBehind="GETS_CompanyInfo_US.aspx.cs" Inherits="GGGETSWeb.GETS_CompanyInfo_US" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>
...
<img width="200" height="120" class="cq-dd-flash" title="" alt="" src="Images/CompanyInfo/image.jpg">
        </a>   
		</div>
...
<div class="content_main_container">
	...
	<div class="breadcrumb" style="">
	    &nbsp;<a href="#">GETS&nbsp;USA</a>&nbsp;<span class="separator">|</span> <strong>ABOUT US</strong>
            ...
            <div class="pagetitle"><h1>COMPANY PROFILE</h1>
<div class="richtext">GETS Is Global logistics industry, market pioneers<br><b><i>The </i>Logistics company for the world</b>.</div></div>
...
<div>
    <h2>
        <a title="" href="#">
            GETS-Provide the best service
        </a>&nbsp;</h2>
    <div class="ct_image img_large">
        <a title="" href="#">
            <img width="220" height="100" class="cq-dd-image shadow_img" title="" alt="" src="Images/CompanyInfo/1097_General_220x100.jpg">
        </a>&nbsp;</div>
    <div class="richtext">GETS Focus on customer needs, management and transport for your letters, articles and information to provide fully integrated customized solutions</div>
</div>
<div style="clear:both"></div>
</div>
</div>
