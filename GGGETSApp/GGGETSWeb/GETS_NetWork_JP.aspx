<%@ Page Title="" Language="C#" MasterPageFile="~/GETS.Master" AutoEventWireup="true" CodeBehind="GETS_NetWork_JP.aspx.cs" Inherits="GGGETSWeb.GETS_NetWork_JP" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>
...
<div class="content_main_container">
	...
	<div class="breadcrumb" style="">
	    &nbsp;<a href="#">GETS&nbsp;中国</a>&nbsp;<span class="separator">|</span> <strong>サービス案内</strong>
            ...
            <div class="pagetitle"><h1>営業ネットワーク</h1>
<div class="richtext">GETS グローバル物流業界の規範の支持者<br><b><i>The </i>Logistics company for the world</b>.</div></div>
...
<div>
    ...
    <div class="richtext">当社の従業員は私たちの成功への鍵です。彼らは従業員の世界と高い士気世界中から情熱のグループです。</div>
</div>
<div style="clear:both"></div>
</div>
</div>
