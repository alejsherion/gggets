<%@ Page Title="" Language="C#" MasterPageFile="~/GETS.Master" AutoEventWireup="true" CodeBehind="GETS_About_US.aspx.cs" Inherits="GGGETSWeb.GETS_About_US" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>
...
<img width="200" height="120" class="cq-dd-flash" title="" alt="" src="Images/about/image.png">
        </a>   
		</div>
...
<div class="content_main_container">
	...
	<div class="breadcrumb" style="">
	    &nbsp;<a href="#">GETS&nbsp;USA</a>&nbsp;<span class="separator">|</span> <strong>ABOUT US</strong>

</div>
</div>

            
            <div class="pagetitle"><h1>ABOUT US</h1>
<div class="richtext">GETS Is The global market leader in logistics industry<br><b><i>The </i>Logistics company for the world</b>.</div></div>
    ...
    <div class="spreadsheet">
        <div class="tableborder">
            <table border="0">
                <tbody>
                    <tr>
                        <th width="30%" axis="length" scope="col">Company Name</th>
                    ...
                    <tr>
                        <th>TEL： 04-7626-3898<br></th>
                    </tr>

                    <tr>
                        <th>FAX： 04-7626-3898　<br></th>
                    </tr>

                    <tr>
                        <th width="30%" axis="length" scope="col">Create Date</th>
                        <th width="50%" axis="length" scope="col">2010</th>
                    </tr>

                    <tr>
                        <th width="30%" axis="length" scope="col">Business Start Date</th>
                        <th width="50%" axis="length" scope="col">2010</th>
                    </tr>

                    <tr>
                        <th width="30%" axis="length" scope="col">Funds</th>
                        <th width="50%" axis="length" scope="col">500 Million</th>
                    </tr>

                    <tr>
                        <th width="30%" axis="length" scope="col">representative</th>
                        <th width="50%" axis="length" scope="col">Chen Cong</th>
                    </tr>
                    ...
                    <tr>
                        <th width="30%" axis="length" scope="col">Industry Type</th>
                        <th width="50%" axis="length" scope="col">Express Logistics</th>
                    </tr>
                    <tr>
                        <th width="30%" axis="length" scope="col">Legal representative</th>
                        <th width="50%" axis="length" scope="col">Chen Cong</th>
                    </tr>
                    <tr>
                        <th width="30%" axis="length" scope="col" rowspan="5">Business Scope</th>
                        <th width="50%" axis="length" scope="col">Sea, land, air</th>
                    </tr>
                     <tr>
                        <th width="50%" axis="length" scope="col">Domestic and international courier services</th>
                    </tr>
                    <tr>
                        <th width="50%" axis="length" scope="col">Customs clearance, warehousing, cargo transport vehicles</th>
                    </tr>
                    <tr>
                        <th width="50%" axis="length" scope="col">Import and export trade and agency business</th>
                    </tr>
                    <tr>
                        <th width="50%" axis="length" scope="col">Network communication equipment such as systems development, software development and maintenance</th>
                    </tr>
                </tbody>
            </table>
        </div>
...
<a style="visibility:hidden" name="containerpar_productlist_1"></a><div class="section productlist"><div class="dhl">
    <h2>●Network</h2>
    <div class="spreadsheet">
        <div class="tableborder">
            <table border="0">
                <tbody>
                    <tr>
                        <th width="30%" axis="length" scope="col" rowspan="12">China</th>
                        <th width="50%" axis="length" scope="col">GETS CO.,LTD.</th>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <th width="30%" axis="length" scope="col" rowspan="4">Japan</th>
                    ...
                    <tr>
                        <th width="50%" axis="length" scope="col">FAX：04-7626-3898　</th>
                    </tr>
                </tbody>
            </table>
        </div>
...
<a style="visibility:hidden" name="containerpar_standardlink_1b5e"></a>
<a style="visibility:hidden" name="containerpar_standardlink_926a"></a><div class="section standardlink">
	<a target="_self" title="" class="arrowLink" href="/zh/about_us/forwarding_freight.html">
		<span class="secret">Learn more about our specialized division</span>
		
	</a></div>
<a style="visibility:hidden" name="containerpar_standardlink_e103"></a>
<a style="visibility:hidden" name="containerpar_componentseparator_0"></a><div class="componentseparator section parbase"><div class="spacer"><hr></div></div>
...
<div>
    ...
    <div class="richtext">●Company Philosophy<br><a href="#" class="arrowLinkUp">GETS Relying on advanced network management in a safe, accurate, fast, is the package delivery service for the life of ideas, providing our customers with high-quality express services, seeking to win a broader space.</a><br><a href="#" class="arrowLinkUp">Scientific management to add value and mutual benefit and win-win development</a></div>
</div>
<div style="clear:both"></div>
</div>
</div>
...
<div class="cq-dd-paragraph" style="display:inline;"><div class="countryselector">
<div class="module">
<!--right block-->
