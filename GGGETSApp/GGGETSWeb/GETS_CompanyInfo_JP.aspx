<%@ Page Title="" Language="C#" MasterPageFile="~/GETS.Master" AutoEventWireup="true" CodeBehind="GETS_CompanyInfo_JP.aspx.cs" Inherits="GGGETSWeb.GETS_CompanyInfo_JP" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>
...
<div class="content_main_container">
	...
	<div class="breadcrumb" style="">
	    &nbsp;<a href="#">GETS&nbsp;中国</a>&nbsp;<span class="separator">|</span> <strong>サービス案内</strong>
            ...
            <div class="pagetitle"><h1>会社概要</h1>
<div class="richtext">GETS グローバル物流業界、市場の先駆者<br><b><i>The </i>Logistics company for the world</b>.</div></div>
        ...
        <div class="tableborder">
            <table border="0">
                <tbody>
                    ...
                    <tr>
                        <th width="50%" axis="length" scope="col">コンピュータネットワーク、通信機器等のシステム開発、ソフトウエア開発及び保守作業</th>
                    </tr>
                </tbody>
            </table>
        </div>
...
<div>
    ...
    <div class="richtext">顧客のニーズ、管理、輸送あなたの手紙は、記事や情報のジェの焦点は完全に統合されたカスタマイズされたソリューションを提供するために</div>
</div>
<div style="clear:both"></div>
</div>
</div>
